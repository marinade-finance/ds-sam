...
export class AuctionConstraints {
  ...
  bondStakeCapSam(validator: AuctionValidator): number {
    ...
    validator.bondMinPmpe = minBondPmpe
    validator.bondIdealPmpe = idealBondPmpe
    validator.bondMinUnprotectedReserve = minUnprotectedReserve
    validator.bondIdealUnprotectedReserve = idealUnprotectedReserve
