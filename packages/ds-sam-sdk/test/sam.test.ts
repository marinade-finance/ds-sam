...
describe('sam', () => {
  ...
  describe.only('test dynamic commission', () => {
    it('ds sam sdk run', async () => {
      ...
      expect(backStopValidator.values.commissions.blockRewardsCommissionInBondsDec).toEqual(0)
      expect(backStopValidator.values.commissions.inflationCommissionDec).toEqual(0)
      expect(backStopValidator.values.commissions.inflationCommissionInBondsDec).toEqual(0)
      ...
      expect(backStopValidator.values.commissions.mevCommissionInBondsDec).toEqual(0)
      ...
      expect(poorValidator.values.commissions.blockRewardsCommissionInBondsDec).toEqual(0.98)
      expect(poorValidator.values.commissions.inflationCommissionDec).toEqual(0.04)
      expect(poorValidator.values.commissions.inflationCommissionInBondsDec).toEqual(0.04)
      ...
      expect(poorValidator.values.commissions.mevCommissionInBondsDec).toEqual(0.01)
