...
function makeValidator(
  ...
  return {
    ...
    bondMinPmpe: revShare.onchainDistributedPmpe + revShare.expectedMaxEffBidPmpe + minBidReservePmpe,
    bondIdealPmpe: revShare.onchainDistributedPmpe + revShare.expectedMaxEffBidPmpe + idealBidReservePmpe,
    bondMinUnprotectedReserve: 0,
    bondIdealUnprotectedReserve: 0,
